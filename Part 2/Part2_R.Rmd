...
ggplot(flight_age_delay, aes(x = airplane_age, y = arrdelay, color = as.factor(year))) +
  geom_point(alpha = 0.3, size = 1) +
  labs(
    title = "Arrival Delay vs Airplane Age by Year",
    x = "Airplane Age (years)",
    y = "Arrival Delay (minutes)",
    color = "Year"
  ) +
  coord_cartesian(xlim = c(0, 50), ylim = c(-100, 300)) +  # adjust if needed
  theme_minimal()
